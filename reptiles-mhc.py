...
'''
files = ['/Users/franciscogambondeza/.mounty/rap/igls/reptiles/ncbi/Squamata/Podarcis_cretensis/GCA_951804945.1_rPodCre2.1_genomic.fna']
for file in files:
    corte = file.split('/')
    animal = corte[-2]
    especie = file.split(corte[-1])[0] + 'mhc'
    # especie ='igls_tcrs'
    if os.path.exists(especie) is False:
        os.mkdir(especie)
    print(animal, file)
    qquery = '/Users/franciscogambondeza/.mounty/rap/reposteria/aaa/reptiles/query-rep-mhc.text'
    ...
    chs = ['back', 'exon2_I', 'exon3_I', 'exon4_I', 'exon2_DA', 'exon3_DA', 'exon2_DB', 'exon3_DB', 'exon2_DMA',
           'exon3_DMA', 'exon2_DMB', 'exon3_DMB', 'beta2', 'exon2_CD1', 'exon3_CD1', 'exon4_CD1']

    path = '/Users/franciscogambondeza/.mounty/rap/reposteria/aaa/reptiles/mhc'
    ...
    ccc = 0
    o = open(especie + '/result-mhc.fasta', 'w')
